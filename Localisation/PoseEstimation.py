...
class PoseEstimator(Tracker):
    ...
    def computePose(self):
        ...
        if len(self.homography) > 0:
            ...
            imagePoints = cv.perspectiveTransform(self.targetCorners, self.homography)

            # Solve the PnP problem
            success, rvecs, tvecs = cv.solvePnP(self.objectCorners, imagePoints, self.cameraMatrix, self.distCoeffs)
