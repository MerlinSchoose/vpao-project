...
class Registration:
    ...
    def processGlobal(self):
        ...
        result = o3d.registration.registration_ransac_based_on_feature_matching(
            self.sourceDown, self.targetDown, self.sourceFpfh, self.targetFpfh, maxCorrespondanceDistance,
            o3d.registration.TransformationEstimationPointToPoint(False), 4, [
                o3d.registration.CorrespondenceCheckerBasedOnEdgeLength(0.9),
                o3d.registration.CorrespondenceCheckerBasedOnDistance(maxCorrespondanceDistance)
    ...
    def processICP(self, pointToPlane = False):
        ...
        if not pointToPlane:
            ...
            result = o3d.registration.registration_icp(
                self.source, self.target, distanceThreshold, self.result.transformation,
